...
import hr.pishe.config.DefaultProfileUtil;
...
public class VoldemortApp {
    ...
    public VoldemortApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes voldemort.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VoldemortApp.class);
