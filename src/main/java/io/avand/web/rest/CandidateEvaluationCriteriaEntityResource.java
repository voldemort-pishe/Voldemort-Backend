...
@RestController
@RequestMapping("/api")
public class CandidateEvaluationCriteriaEntityResource {

    private final Logger log = LoggerFactory.getLogger(CandidateEvaluationCriteriaEntityResource.class);

    private static final String ENTITY_NAME = "candidateEvaluationCriteriaEntity";

    private final CandidateEvaluationCriteriaEntityRepository candidateEvaluationCriteriaEntityRepository;

    public CandidateEvaluationCriteriaEntityResource(CandidateEvaluationCriteriaEntityRepository candidateEvaluationCriteriaEntityRepository) {
        this.candidateEvaluationCriteriaEntityRepository = candidateEvaluationCriteriaEntityRepository;
    }
    ...
    public ResponseEntity<CandidateEvaluationCriteriaEntity> createCandidateEvaluationCriteriaEntity(@RequestBody CandidateEvaluationCriteriaEntity candidateEvaluationCriteriaEntity) throws URISyntaxException {
        ...
        CandidateEvaluationCriteriaEntity result = candidateEvaluationCriteriaEntityRepository.save(candidateEvaluationCriteriaEntity);
    ...
    public List<CandidateEvaluationCriteriaEntity> getAllCandidateEvaluationCriteriaEntities() {
        ...
        return candidateEvaluationCriteriaEntityRepository.findAll();
        }
    ...
    public ResponseEntity<CandidateEvaluationCriteriaEntity> getCandidateEvaluationCriteriaEntity(@PathVariable Long id) {
        ...
        CandidateEvaluationCriteriaEntity candidateEvaluationCriteriaEntity = candidateEvaluationCriteriaEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteCandidateEvaluationCriteriaEntity(@PathVariable Long id) {
        ...
        candidateEvaluationCriteriaEntityRepository.delete(id);
