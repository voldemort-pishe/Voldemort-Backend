...
@RestController
@RequestMapping("/api")
public class CandidateScheduleEntityResource {

    private final Logger log = LoggerFactory.getLogger(CandidateScheduleEntityResource.class);

    private static final String ENTITY_NAME = "candidateScheduleEntity";

    private final CandidateScheduleEntityRepository candidateScheduleEntityRepository;

    public CandidateScheduleEntityResource(CandidateScheduleEntityRepository candidateScheduleEntityRepository) {
        this.candidateScheduleEntityRepository = candidateScheduleEntityRepository;
    }
    ...
    public ResponseEntity<CandidateScheduleEntity> createCandidateScheduleEntity(@RequestBody CandidateScheduleEntity candidateScheduleEntity) throws URISyntaxException {
        ...
        CandidateScheduleEntity result = candidateScheduleEntityRepository.save(candidateScheduleEntity);
    ...
    public List<CandidateScheduleEntity> getAllCandidateScheduleEntities() {
        ...
        return candidateScheduleEntityRepository.findAll();
        }
    ...
    public ResponseEntity<CandidateScheduleEntity> getCandidateScheduleEntity(@PathVariable Long id) {
        ...
        CandidateScheduleEntity candidateScheduleEntity = candidateScheduleEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteCandidateScheduleEntity(@PathVariable Long id) {
        ...
        candidateScheduleEntityRepository.delete(id);
