...
public class CommentEntityResource {
    ...
    public CommentEntityResource(CommentEntityRepository commentEntityRepository) {
    ...
    public ResponseEntity<CommentEntity> createCommentEntity(@RequestBody CommentEntity commentEntity) throws URISyntaxException {
        ...
        CommentEntity result = commentEntityRepository.save(commentEntity);
    ...
    public ResponseEntity<CommentEntity> getCommentEntity(@PathVariable Long id) {
        ...
        CommentEntity commentEntity = commentEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteCommentEntity(@PathVariable Long id) {
        ...
        commentEntityRepository.delete(id);
