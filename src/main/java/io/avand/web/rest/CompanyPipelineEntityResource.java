...
@RestController
@RequestMapping("/api")
public class CompanyPipelineEntityResource {

    private final Logger log = LoggerFactory.getLogger(CompanyPipelineEntityResource.class);

    private static final String ENTITY_NAME = "companyPipelineEntity";

    private final CompanyPipelineEntityRepository companyPipelineEntityRepository;

    public CompanyPipelineEntityResource(CompanyPipelineEntityRepository companyPipelineEntityRepository) {
        this.companyPipelineEntityRepository = companyPipelineEntityRepository;
    }
    ...
    public ResponseEntity<CompanyPipelineEntity> createCompanyPipelineEntity(@RequestBody CompanyPipelineEntity companyPipelineEntity) throws URISyntaxException {
        ...
        CompanyPipelineEntity result = companyPipelineEntityRepository.save(companyPipelineEntity);
    ...
    public List<CompanyPipelineEntity> getAllCompanyPipelineEntities() {
        ...
        return companyPipelineEntityRepository.findAll();
        }
    ...
    public ResponseEntity<CompanyPipelineEntity> getCompanyPipelineEntity(@PathVariable Long id) {
        ...
        CompanyPipelineEntity companyPipelineEntity = companyPipelineEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteCompanyPipelineEntity(@PathVariable Long id) {
        ...
        companyPipelineEntityRepository.delete(id);
