...
@RestController
@RequestMapping("/api")
public class EvaluationCriteriaEntityResource {

    private final Logger log = LoggerFactory.getLogger(EvaluationCriteriaEntityResource.class);

    private static final String ENTITY_NAME = "evaluationCriteriaEntity";

    private final EvaluationCriteriaEntityRepository evaluationCriteriaEntityRepository;

    public EvaluationCriteriaEntityResource(EvaluationCriteriaEntityRepository evaluationCriteriaEntityRepository) {
        this.evaluationCriteriaEntityRepository = evaluationCriteriaEntityRepository;
    }
    ...
    public ResponseEntity<EvaluationCriteriaEntity> createEvaluationCriteriaEntity(@RequestBody EvaluationCriteriaEntity evaluationCriteriaEntity) throws URISyntaxException {
        ...
        EvaluationCriteriaEntity result = evaluationCriteriaEntityRepository.save(evaluationCriteriaEntity);
    ...
    public List<EvaluationCriteriaEntity> getAllEvaluationCriteriaEntities() {
        ...
        return evaluationCriteriaEntityRepository.findAll();
        }
    ...
    public ResponseEntity<EvaluationCriteriaEntity> getEvaluationCriteriaEntity(@PathVariable Long id) {
        ...
        EvaluationCriteriaEntity evaluationCriteriaEntity = evaluationCriteriaEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteEvaluationCriteriaEntity(@PathVariable Long id) {
        ...
        evaluationCriteriaEntityRepository.delete(id);
