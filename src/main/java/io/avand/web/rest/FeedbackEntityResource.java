...
@RestController
@RequestMapping("/api")
public class FeedbackEntityResource {

    private final Logger log = LoggerFactory.getLogger(FeedbackEntityResource.class);

    private static final String ENTITY_NAME = "feedbackEntity";

    private final FeedbackEntityRepository feedbackEntityRepository;

    public FeedbackEntityResource(FeedbackEntityRepository feedbackEntityRepository) {
    ...
    public ResponseEntity<FeedbackEntity> createFeedbackEntity(@RequestBody FeedbackEntity feedbackEntity) throws URISyntaxException {
        ...
        FeedbackEntity result = feedbackEntityRepository.save(feedbackEntity);
    ...
    public ResponseEntity<FeedbackEntity> getFeedbackEntity(@PathVariable Long id) {
        ...
        FeedbackEntity feedbackEntity = feedbackEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteFeedbackEntity(@PathVariable Long id) {
        ...
        feedbackEntityRepository.delete(id);
