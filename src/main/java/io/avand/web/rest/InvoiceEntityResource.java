...
public class InvoiceEntityResource {
    ...
    private final Logger log = LoggerFactory.getLogger(InvoiceEntityResource.class);

    private static final String ENTITY_NAME = "invoiceEntity";

    private final InvoiceEntityRepository invoiceEntityRepository;

    public InvoiceEntityResource(InvoiceEntityRepository invoiceEntityRepository) {
    ...
    public ResponseEntity<InvoiceEntity> createInvoiceEntity(@RequestBody InvoiceEntity invoiceEntity) throws URISyntaxException {
        ...
        InvoiceEntity result = invoiceEntityRepository.save(invoiceEntity);
    ...
    public ResponseEntity<InvoiceEntity> getInvoiceEntity(@PathVariable Long id) {
        ...
        InvoiceEntity invoiceEntity = invoiceEntityRepository.findOne(id);
