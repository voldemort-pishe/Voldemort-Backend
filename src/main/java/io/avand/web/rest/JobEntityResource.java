...
@RestController
@RequestMapping("/api")
public class JobEntityResource {

    private final Logger log = LoggerFactory.getLogger(JobEntityResource.class);

    private static final String ENTITY_NAME = "jobEntity";

    private final JobEntityRepository jobEntityRepository;

    public JobEntityResource(JobEntityRepository jobEntityRepository) {
    ...
    public ResponseEntity<JobEntity> createJobEntity(@Valid @RequestBody JobEntity jobEntity) throws URISyntaxException {
        ...
        JobEntity result = jobEntityRepository.save(jobEntity);
    ...
    public ResponseEntity<JobEntity> getJobEntity(@PathVariable Long id) {
        ...
        JobEntity jobEntity = jobEntityRepository.findOne(id);
