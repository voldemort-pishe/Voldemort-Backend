...
import io.avand.repository.PaymentTransactionRepository;
...
public class PaymentTransactionResource {
    ...
    public ResponseEntity<PaymentTransactionEntity> createPaymentTransactionEntity(@RequestBody PaymentTransactionEntity paymentTransactionEntity) throws URISyntaxException {
        ...
        PaymentTransactionEntity result = paymentTransactionRepository.save(paymentTransactionEntity);
    ...
    public ResponseEntity<PaymentTransactionEntity> getPaymentTransactionEntity(@PathVariable Long id) {
        ...
        PaymentTransactionEntity paymentTransactionEntity = paymentTransactionRepository.findOne(id);
