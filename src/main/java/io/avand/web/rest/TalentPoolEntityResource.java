...
@RestController
@RequestMapping("/api")
public class TalentPoolEntityResource {

    private final Logger log = LoggerFactory.getLogger(TalentPoolEntityResource.class);

    private static final String ENTITY_NAME = "talentPoolEntity";

    private final TalentPoolEntityRepository talentPoolEntityRepository;

    public TalentPoolEntityResource(TalentPoolEntityRepository talentPoolEntityRepository) {
        this.talentPoolEntityRepository = talentPoolEntityRepository;
    }
    ...
    public ResponseEntity<TalentPoolEntity> createTalentPoolEntity(@RequestBody TalentPoolEntity talentPoolEntity) throws URISyntaxException {
        ...
        TalentPoolEntity result = talentPoolEntityRepository.save(talentPoolEntity);
    ...
    public List<TalentPoolEntity> getAllTalentPoolEntities() {
        ...
        return talentPoolEntityRepository.findAll();
        }
    ...
    public ResponseEntity<TalentPoolEntity> getTalentPoolEntity(@PathVariable Long id) {
        ...
        TalentPoolEntity talentPoolEntity = talentPoolEntityRepository.findOne(id);
    ...
    public ResponseEntity<Void> deleteTalentPoolEntity(@PathVariable Long id) {
        ...
        talentPoolEntityRepository.delete(id);
