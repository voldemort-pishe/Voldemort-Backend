...
import io.avand.repository.CandidateEvaluationCriteriaRepository;
 ...
 *
 * @see CandidateEvaluationCriteriaResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class CandidateEvaluationCriteriaResourceIntTest {
    ...
    @Autowired
    private CandidateEvaluationCriteriaRepository candidateEvaluationCriteriaRepository;
    ...
    public void setup() {
        ...
        final CandidateEvaluationCriteriaResource candidateEvaluationCriteriaResource = new CandidateEvaluationCriteriaResource(candidateEvaluationCriteriaRepository);
        this.restCandidateEvaluationCriteriaEntityMockMvc = MockMvcBuilders.standaloneSetup(candidateEvaluationCriteriaResource)
    ...
    public void createCandidateEvaluationCriteriaEntity() throws Exception {
        int databaseSizeBeforeCreate = candidateEvaluationCriteriaRepository.findAll().size();
        ...
        List<CandidateEvaluationCriteriaEntity> candidateEvaluationCriteriaEntityList = candidateEvaluationCriteriaRepository.findAll();
    ...
    public void getAllCandidateEvaluationCriteriaEntities() throws Exception {
        ...
        candidateEvaluationCriteriaRepository.saveAndFlush(candidateEvaluationCriteriaEntity);
    ...
    public void updateCandidateEvaluationCriteriaEntity() throws Exception {
        // Initialize the database
        candidateEvaluationCriteriaRepository.saveAndFlush(candidateEvaluationCriteriaEntity);
        int databaseSizeBeforeUpdate = candidateEvaluationCriteriaRepository.findAll().size();

        // Update the candidateEvaluationCriteriaEntity
        CandidateEvaluationCriteriaEntity updatedCandidateEvaluationCriteriaEntity = candidateEvaluationCriteriaRepository.findOne(candidateEvaluationCriteriaEntity.getId());
    ...
    public void deleteCandidateEvaluationCriteriaEntity() throws Exception {
        // Initialize the database
        candidateEvaluationCriteriaRepository.saveAndFlush(candidateEvaluationCriteriaEntity);
        int databaseSizeBeforeDelete = candidateEvaluationCriteriaRepository.findAll().size();
