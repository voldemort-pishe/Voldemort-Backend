...
import io.avand.repository.CandidateScheduleEntityRepository;
 ...
 *
 * @see CandidateScheduleEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class CandidateScheduleEntityResourceIntTest {
    ...
    @Autowired
    private CandidateScheduleEntityRepository candidateScheduleEntityRepository;
    ...
    public void setup() {
        ...
        final CandidateScheduleEntityResource candidateScheduleEntityResource = new CandidateScheduleEntityResource(candidateScheduleEntityRepository);
        this.restCandidateScheduleEntityMockMvc = MockMvcBuilders.standaloneSetup(candidateScheduleEntityResource)
    ...
    public void createCandidateScheduleEntity() throws Exception {
        int databaseSizeBeforeCreate = candidateScheduleEntityRepository.findAll().size();
        ...
        List<CandidateScheduleEntity> candidateScheduleEntityList = candidateScheduleEntityRepository.findAll();
    ...
    public void getAllCandidateScheduleEntities() throws Exception {
        ...
        candidateScheduleEntityRepository.saveAndFlush(candidateScheduleEntity);
    ...
    public void updateCandidateScheduleEntity() throws Exception {
        // Initialize the database
        candidateScheduleEntityRepository.saveAndFlush(candidateScheduleEntity);
        int databaseSizeBeforeUpdate = candidateScheduleEntityRepository.findAll().size();

        // Update the candidateScheduleEntity
        CandidateScheduleEntity updatedCandidateScheduleEntity = candidateScheduleEntityRepository.findOne(candidateScheduleEntity.getId());
    ...
    public void deleteCandidateScheduleEntity() throws Exception {
        // Initialize the database
        candidateScheduleEntityRepository.saveAndFlush(candidateScheduleEntity);
        int databaseSizeBeforeDelete = candidateScheduleEntityRepository.findAll().size();
