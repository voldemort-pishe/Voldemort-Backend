 ...
 *
 * @see CompanyEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class CompanyEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final CompanyEntityResource companyEntityResource = new CompanyEntityResource(companyEntityRepository);
        this.restCompanyEntityMockMvc = MockMvcBuilders.standaloneSetup(companyEntityResource)
    ...
    public void updateCompanyEntity() throws Exception {
        ...
        CompanyEntity updatedCompanyEntity = companyEntityRepository.findOne(companyEntity.getId());
