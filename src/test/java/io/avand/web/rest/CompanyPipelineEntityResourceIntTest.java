...
import io.avand.repository.CompanyPipelineEntityRepository;
 ...
 *
 * @see CompanyPipelineEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class CompanyPipelineEntityResourceIntTest {
    ...
    @Autowired
    private CompanyPipelineEntityRepository companyPipelineEntityRepository;
    ...
    public void setup() {
        ...
        final CompanyPipelineEntityResource companyPipelineEntityResource = new CompanyPipelineEntityResource(companyPipelineEntityRepository);
        this.restCompanyPipelineEntityMockMvc = MockMvcBuilders.standaloneSetup(companyPipelineEntityResource)
    ...
    public void createCompanyPipelineEntity() throws Exception {
        int databaseSizeBeforeCreate = companyPipelineEntityRepository.findAll().size();
        ...
        List<CompanyPipelineEntity> companyPipelineEntityList = companyPipelineEntityRepository.findAll();
    ...
    public void getAllCompanyPipelineEntities() throws Exception {
        ...
        companyPipelineEntityRepository.saveAndFlush(companyPipelineEntity);
    ...
    public void updateCompanyPipelineEntity() throws Exception {
        // Initialize the database
        companyPipelineEntityRepository.saveAndFlush(companyPipelineEntity);
        int databaseSizeBeforeUpdate = companyPipelineEntityRepository.findAll().size();

        // Update the companyPipelineEntity
        CompanyPipelineEntity updatedCompanyPipelineEntity = companyPipelineEntityRepository.findOne(companyPipelineEntity.getId());
    ...
    public void deleteCompanyPipelineEntity() throws Exception {
        // Initialize the database
        companyPipelineEntityRepository.saveAndFlush(companyPipelineEntity);
        int databaseSizeBeforeDelete = companyPipelineEntityRepository.findAll().size();
