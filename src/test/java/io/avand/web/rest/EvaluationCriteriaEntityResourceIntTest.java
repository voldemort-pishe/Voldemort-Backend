...
import io.avand.repository.EvaluationCriteriaEntityRepository;
 ...
 *
 * @see EvaluationCriteriaEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class EvaluationCriteriaEntityResourceIntTest {
    ...
    @Autowired
    private EvaluationCriteriaEntityRepository evaluationCriteriaEntityRepository;
    ...
    public void setup() {
        ...
        final EvaluationCriteriaEntityResource evaluationCriteriaEntityResource = new EvaluationCriteriaEntityResource(evaluationCriteriaEntityRepository);
        this.restEvaluationCriteriaEntityMockMvc = MockMvcBuilders.standaloneSetup(evaluationCriteriaEntityResource)
    ...
    public void createEvaluationCriteriaEntity() throws Exception {
        int databaseSizeBeforeCreate = evaluationCriteriaEntityRepository.findAll().size();
        ...
        List<EvaluationCriteriaEntity> evaluationCriteriaEntityList = evaluationCriteriaEntityRepository.findAll();
    ...
    public void getAllEvaluationCriteriaEntities() throws Exception {
        ...
        evaluationCriteriaEntityRepository.saveAndFlush(evaluationCriteriaEntity);
    ...
    public void updateEvaluationCriteriaEntity() throws Exception {
        // Initialize the database
        evaluationCriteriaEntityRepository.saveAndFlush(evaluationCriteriaEntity);
        int databaseSizeBeforeUpdate = evaluationCriteriaEntityRepository.findAll().size();

        // Update the evaluationCriteriaEntity
        EvaluationCriteriaEntity updatedEvaluationCriteriaEntity = evaluationCriteriaEntityRepository.findOne(evaluationCriteriaEntity.getId());
    ...
    public void deleteEvaluationCriteriaEntity() throws Exception {
        // Initialize the database
        evaluationCriteriaEntityRepository.saveAndFlush(evaluationCriteriaEntity);
        int databaseSizeBeforeDelete = evaluationCriteriaEntityRepository.findAll().size();
