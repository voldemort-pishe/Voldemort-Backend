...
import io.avand.repository.FeedbackEntityRepository;
 ...
 *
 * @see FeedbackEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class FeedbackEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FeedbackEntityResource feedbackEntityResource = new FeedbackEntityResource(feedbackEntityRepository);
        this.restFeedbackEntityMockMvc = MockMvcBuilders.standaloneSetup(feedbackEntityResource)
    ...
    public void createFeedbackEntity() throws Exception {
        int databaseSizeBeforeCreate = feedbackEntityRepository.findAll().size();
    ...
    public void getAllFeedbackEntities() throws Exception {
        ...
        feedbackEntityRepository.saveAndFlush(feedbackEntity);
    ...
    public void updateFeedbackEntity() throws Exception {
        // Initialize the database
        feedbackEntityRepository.saveAndFlush(feedbackEntity);
        int databaseSizeBeforeUpdate = feedbackEntityRepository.findAll().size();

        // Update the feedbackEntity
        FeedbackEntity updatedFeedbackEntity = feedbackEntityRepository.findOne(feedbackEntity.getId());
    ...
    public void deleteFeedbackEntity() throws Exception {
        // Initialize the database
        feedbackEntityRepository.saveAndFlush(feedbackEntity);
        int databaseSizeBeforeDelete = feedbackEntityRepository.findAll().size();
