 ...
 *
 * @see FileEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class FileEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FileEntityResource fileEntityResource = new FileEntityResource(fileEntityRepository);
        this.restFileEntityMockMvc = MockMvcBuilders.standaloneSetup(fileEntityResource)
    ...
    public void createFileEntity() throws Exception {
        int databaseSizeBeforeCreate = fileEntityRepository.findAll().size();
    ...
    public void updateFileEntity() throws Exception {
        // Initialize the database
        fileEntityRepository.saveAndFlush(fileEntity);
        int databaseSizeBeforeUpdate = fileEntityRepository.findAll().size();

        // Update the fileEntity
        FileEntity updatedFileEntity = fileEntityRepository.findOne(fileEntity.getId());
    ...
    public void deleteFileEntity() throws Exception {
        // Initialize the database
        fileEntityRepository.saveAndFlush(fileEntity);
        int databaseSizeBeforeDelete = fileEntityRepository.findAll().size();
