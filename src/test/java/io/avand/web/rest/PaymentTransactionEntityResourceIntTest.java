 ...
 *
 * @see PaymentTransactionEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class PaymentTransactionEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final PaymentTransactionEntityResource paymentTransactionEntityResource = new PaymentTransactionEntityResource(paymentTransactionEntityRepository);
        this.restPaymentTransactionEntityMockMvc = MockMvcBuilders.standaloneSetup(paymentTransactionEntityResource)
    ...
    public void createPaymentTransactionEntity() throws Exception {
        int databaseSizeBeforeCreate = paymentTransactionEntityRepository.findAll().size();
        ...
        List<PaymentTransactionEntity> paymentTransactionEntityList = paymentTransactionEntityRepository.findAll();
    ...
    public void getAllPaymentTransactionEntities() throws Exception {
        ...
        paymentTransactionEntityRepository.saveAndFlush(paymentTransactionEntity);
    ...
    public void updatePaymentTransactionEntity() throws Exception {
        // Initialize the database
        paymentTransactionEntityRepository.saveAndFlush(paymentTransactionEntity);
        int databaseSizeBeforeUpdate = paymentTransactionEntityRepository.findAll().size();

        // Update the paymentTransactionEntity
        PaymentTransactionEntity updatedPaymentTransactionEntity = paymentTransactionEntityRepository.findOne(paymentTransactionEntity.getId());
    ...
    public void deletePaymentTransactionEntity() throws Exception {
        // Initialize the database
        paymentTransactionEntityRepository.saveAndFlush(paymentTransactionEntity);
        int databaseSizeBeforeDelete = paymentTransactionEntityRepository.findAll().size();
