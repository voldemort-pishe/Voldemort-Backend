...
import io.avand.repository.TalentPoolEntityRepository;
 ...
 *
 * @see TalentPoolEntityResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = VoldemortApp.class)
public class TalentPoolEntityResourceIntTest {
    ...
    @Autowired
    private TalentPoolEntityRepository talentPoolEntityRepository;
    ...
    public void setup() {
        ...
        final TalentPoolEntityResource talentPoolEntityResource = new TalentPoolEntityResource(talentPoolEntityRepository);
        this.restTalentPoolEntityMockMvc = MockMvcBuilders.standaloneSetup(talentPoolEntityResource)
    ...
    public void createTalentPoolEntity() throws Exception {
        int databaseSizeBeforeCreate = talentPoolEntityRepository.findAll().size();
        ...
        List<TalentPoolEntity> talentPoolEntityList = talentPoolEntityRepository.findAll();
    ...
    public void getAllTalentPoolEntities() throws Exception {
        ...
        talentPoolEntityRepository.saveAndFlush(talentPoolEntity);
    ...
    public void updateTalentPoolEntity() throws Exception {
        // Initialize the database
        talentPoolEntityRepository.saveAndFlush(talentPoolEntity);
        int databaseSizeBeforeUpdate = talentPoolEntityRepository.findAll().size();

        // Update the talentPoolEntity
        TalentPoolEntity updatedTalentPoolEntity = talentPoolEntityRepository.findOne(talentPoolEntity.getId());
    ...
    public void deleteTalentPoolEntity() throws Exception {
        // Initialize the database
        talentPoolEntityRepository.saveAndFlush(talentPoolEntity);
        int databaseSizeBeforeDelete = talentPoolEntityRepository.findAll().size();
