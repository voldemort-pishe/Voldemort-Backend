...
describe('Service Tests', () => {
    ...
    describe('AbstractAuditingEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AbstractAuditingEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/abstract-auditing-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AbstractAuditingEntity', () => {
