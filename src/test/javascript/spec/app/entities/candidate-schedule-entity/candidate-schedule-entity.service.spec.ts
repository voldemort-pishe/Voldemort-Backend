...
describe('Service Tests', () => {
    ...
    describe('CandidateScheduleEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CandidateScheduleEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidate-schedule-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CandidateScheduleEntity', () => {
