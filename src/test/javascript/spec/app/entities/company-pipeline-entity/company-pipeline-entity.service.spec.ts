...
describe('Service Tests', () => {
    ...
    describe('CompanyPipelineEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CompanyPipelineEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/company-pipeline-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CompanyPipelineEntity', () => {
