...
describe('Service Tests', () => {
    ...
    describe('EvaluationCriteriaEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EvaluationCriteriaEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/evaluation-criteria-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EvaluationCriteriaEntity', () => {
