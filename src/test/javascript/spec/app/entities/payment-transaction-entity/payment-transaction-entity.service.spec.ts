...
describe('Service Tests', () => {
    ...
    describe('PaymentTransactionEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PaymentTransactionEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/payment-transaction-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PaymentTransactionEntity', () => {
