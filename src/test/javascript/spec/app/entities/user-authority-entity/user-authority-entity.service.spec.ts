...
describe('Service Tests', () => {
    ...
    describe('UserAuthorityEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserAuthorityEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-authority-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserAuthorityEntity', () => {
