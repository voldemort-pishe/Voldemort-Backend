...
describe('Service Tests', () => {
    ...
    describe('UserPermissionEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserPermissionEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-permission-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserPermissionEntity', () => {
